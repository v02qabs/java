...
public class ja2 extends Applet
{
	...
	private BranchGroup createSceneGraph()
	{
		...
		group.addChild(back);
		Point3f[] point = new Point3f[4];
		Color3f[] color = new Color3f[4];
		point[0] = new Point3f(-0.5f, 0.3f, 0.0f);
		point[1] = new Point3f(0.5f, 0.3f, 0.0f);
		point[2] = new Point3f(-0.5f, -0.3f,0.0f);
		point[3] = new Point3f(0.5f, -0.3f, 0.0f);
		color[0] = new Color3f(1.0f, 0.0f, 0.0f);
		color[1] = new Color3f(1.0f, 0.0f, 0.0f);
		color[2] = new Color3f(1.0f , 0.0f, 0.0f);
		color[3] = new Color3f(1.0f, 0.0f, 0.0f);
	...
	{
		MainFrame mf = new MainFrame(new ja2(), 500,500);
	}
}
