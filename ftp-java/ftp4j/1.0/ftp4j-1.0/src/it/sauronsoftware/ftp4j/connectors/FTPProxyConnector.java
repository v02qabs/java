...
public class FTPProxyConnector implements FTPConnector {
	 ...
	 * 
	 * STYLE_SITE_COMMAND - Requires the connection to the remote host through a
	 * SITE command after proxy authentication.
	 * 
	 * STYLE_OPEN_COMMAND - Requires the connection to the remote host through a
	 * OPEN command without proxy authentication.
	 * 
	 * Default value for the style is STYLE_SITE_COMMAND.
	 * 
	 * @param style
