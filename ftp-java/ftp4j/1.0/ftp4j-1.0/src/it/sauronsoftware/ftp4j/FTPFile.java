...
public class FTPFile {
	...
	/**
	 * The type of the entry represented. Could be TYPE_FILE, TYPE_DIRECTORY or
	 * TYPE_LINK.
	 */
	private int type;
	...
	/**
	 * Returns the type of the entry represented. Could be TYPE_FILE,
	 * TYPE_DIRECTORY or TYPE_LINK.
	 * 
	 * @return The type of the entry represented. Could be TYPE_FILE,
	 *         TYPE_DIRECTORY or TYPE_LINK.
	 */
	public int getType() {
		return type;
	...
	/**
	 * Sets the type of the entry represented. Could be TYPE_FILE,
	 * TYPE_DIRECTORY or TYPE_LINK.
	 * 
	 * @param type
	 *            The type of the entry represented. Could be TYPE_FILE,
	 *            TYPE_DIRECTORY or TYPE_LINK.
	 */
